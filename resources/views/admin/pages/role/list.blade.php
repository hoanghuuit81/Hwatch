    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <!-- DATA TABLE -->
                    <h3 class="title-5 m-b-35">Danh sách quyền</h3>
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <form class="form-header" action="#">
                                <input class="au-input au-input--xl" type="text" name="key"
                                    value="{{ request()->input('key') }}" placeholder="Tìm kiếm quyền" />
                        ...
                        <div class="table-data__tool">
                            ...
                            <div class="table-data__tool-right">
                                <a href="{{ route('role.add') }}"
                                    ...
                                    <i class="zmdi zmdi-plus"></i>Thêm quyền</a>
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="{{ route('role.edit', $item->id) }}" class="item"
                                                        data-toggle="tooltip" data-placement="top" title="Chi tiết">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    @if ($item->deleted_at == null)
                                                        <a class="item" href="{{ route('role.delete', $item->id) }}"
