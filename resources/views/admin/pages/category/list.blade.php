                                ...
                                <tbody>
                                    ...
                                    @foreach ($cate as $item)
                                        <tr class="tr-shadow">
                                            ...
                                            @endif
                                            <td>{{ $item->parentCategory ? $item->parentCategory->name : 'Không có danh mục cha' }}</td>
                                            <td>{{ date('d-m-Y', strtotime($item->created_at))  }}</td>
                                            
                                            <td>
                                                <div class="table-data-feature">

                                                    <a href="{{ route('category.edit', $item->id) }}" class="item"
                                                        data-toggle="tooltip" data-placement="top" title="Chi tiết">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </a>
                                                    @if ($item->deleted_at == null)
                                                        <a class="item" href="{{ route('category.delete', $item->id) }}"
